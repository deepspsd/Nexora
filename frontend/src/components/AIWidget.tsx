...
const AIWidget = () => {
  ...
  const hiddenRoutes = ['/dashboard', '/idea-validation', '/mvp-development', '/business-plan', '/research', '/marketing', '/team-collaboration', '/pitch-deck', '/intelligent-chat', '/profile', '/settings'];
